  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_Ctr_consecutivos_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_Ctr_consecutivos_mob_form();
	}
...
?>
  ...
  // ---------- Validate salida
  function do_ajax_Ctr_consecutivos_mob_validate_salida()
  {
    var nomeCampo_salida = "salida";
    var var_salida = scAjaxGetFieldText(nomeCampo_salida);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_Ctr_consecutivos_mob_validate_salida(var_salida, var_script_case_init, do_ajax_Ctr_consecutivos_mob_validate_salida_cb);
  } // do_ajax_Ctr_consecutivos_mob_validate_salida

  function do_ajax_Ctr_consecutivos_mob_validate_salida_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_Ctr_consecutivos_mob_validate_salida_cb

  // ---------- Event onclick scajaxbutton_salidaconsecutivos
  function do_ajax_Ctr_consecutivos_mob_event_scajaxbutton_salidaconsecutivos_onclick()
  {
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_Ctr_consecutivos_mob_event_scajaxbutton_salidaconsecutivos_onclick(var_script_case_init, do_ajax_Ctr_consecutivos_mob_event_scajaxbutton_salidaconsecutivos_onclick_cb);
  } // do_ajax_Ctr_consecutivos_mob_event_scajaxbutton_salidaconsecutivos_onclick

  function do_ajax_Ctr_consecutivos_mob_event_scajaxbutton_salidaconsecutivos_onclick_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "scajaxbutton_salidaconsecutivos";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_Ctr_consecutivos_mob_event_scajaxbutton_salidaconsecutivos_onclick_cb_after_alert);
  } // do_ajax_Ctr_consecutivos_mob_event_scajaxbutton_salidaconsecutivos_onclick_cb
  function do_ajax_Ctr_consecutivos_mob_event_scajaxbutton_salidaconsecutivos_onclick_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_Ctr_consecutivos_mob_event_scajaxbutton_salidaconsecutivos_onclick_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_Ctr_consecutivos_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_Ctr_consecutivos_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_salida = scAjaxGetFieldText("salida");
    ...
    scAjaxProcOn();
    x_ajax_Ctr_consecutivos_mob_submit_form(var_salida, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_Ctr_consecutivos_mob_submit_form_cb);
  } // do_ajax_Ctr_consecutivos_mob_submit_form

  function do_ajax_Ctr_consecutivos_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_Ctr_consecutivos_mob_submit_form_cb_after_alert);
  } // do_ajax_Ctr_consecutivos_mob_submit_form_cb
  function do_ajax_Ctr_consecutivos_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_Ctr_consecutivos_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_Ctr_consecutivos_mob_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_Ctr_consecutivos_mob_navigate_form, function() {});
    } else {
      perform_ajax_Ctr_consecutivos_mob_navigate_form();
    }
  }

  function perform_ajax_Ctr_consecutivos_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    }
  } // do_ajax_Ctr_consecutivos_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['Ctr_consecutivos_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_Ctr_consecutivos_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_Ctr_consecutivos_mob_navigate_form_cb_after_alert);
  } // do_ajax_Ctr_consecutivos_mob_navigate_form_cb
  function do_ajax_Ctr_consecutivos_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_Ctr_consecutivos_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_Ctr_consecutivos_mob_navigate_form_cb_after_alert

  function sc_hide_Ctr_consecutivos_mob_form()
  {
  ...
  ajax_field_list[0] = "salida";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "salida": {"label": "salida", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0}
  };
  ...
  ajax_field_mult["salida"][1] = "salida";
