...
$old_error_handler = set_error_handler("Ctr_consecutivos_mob_scriptcase_error_handler");

function Ctr_consecutivos_mob_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe="")
{
    ...
    if (isset($_SESSION['scriptcase']['Ctr_consecutivos_mob']['contr_erro']) && $_SESSION['scriptcase']['Ctr_consecutivos_mob']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            ...
            $inicial_Ctr_consecutivos_mob->contr_Ctr_consecutivos_mob->Apl_com_erro = true;
            if ($inicial_Ctr_consecutivos_mob->contr_Ctr_consecutivos_mob->NM_ajax_flag)
            {
                $inicial_Ctr_consecutivos_mob->contr_Ctr_consecutivos_mob->NM_ajax_info['errList']['geral_Ctr_consecutivos_mob'][] = $msg;
                return;
            }
            Ctr_consecutivos_mob_scriptcase_error_display($msg, $err_no);
        }
        return;
    }
}

function Ctr_consecutivos_mob_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['Ctr_consecutivos_mob'])  && '' != $_SESSION['scriptcase']['error_icon']['Ctr_consecutivos_mob'])  ? $_SESSION['scriptcase']['error_icon']['Ctr_consecutivos_mob']  : "";
        ...
        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['Ctr_consecutivos_mob']) && '' != $_SESSION['scriptcase']['error_span_title']['Ctr_consecutivos_mob']) ? $_SESSION['scriptcase']['error_span_title']['Ctr_consecutivos_mob'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['Ctr_consecutivos_mob']) && '' != $_SESSION['scriptcase']['error_icon_title']['Ctr_consecutivos_mob']) ? $_SESSION['scriptcase']['error_icon_title']['Ctr_consecutivos_mob'] : '';
?>
