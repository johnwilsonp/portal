...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["Portal_____menu"]))
   {
      unset($_SESSION['session_sec_aplicacao']["Portal_____menu"]);
   }
   ...
   if (isset($_SESSION['scriptcase']['sc_aba_iframe']['menu']))
   {
       unset($_SESSION['scriptcase']['sc_aba_iframe']['menu']);
   }
   $fecha_janela = false;
   if (isset($_SESSION['sc_session'][$script_case_init]['menu']['sc_outra_jan']) && $_SESSION['sc_session'][$script_case_init]['menu']['sc_outra_jan'])
   {
       $fecha_janela = true;
   }
   $fecha_modal = false;
   if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['menu']['aba_saida']) && $_SESSION['sc_session'][$script_case_init]['menu']['aba_saida'] == "modal")
   {
       unset($_SESSION['sc_session'][$script_case_init]['menu']['aba_saida']);
       $fecha_modal = true;
   }
