...
$nm_saida->saida("   <link rel=\"shortcut icon\" href=\"../_lib/img/scriptcase__NM__ico__NM__favicon.ico\">\r\n");
     ...
     $nm_saida->saida("           <A HREF=\"javascript:nm_gp_aba3()\" TARGET=\"_self\">AUTOEVALUACIÓN</A>\r\n");
     $nm_saida->saida("         </li>\r\n");
//
     $cor_celula  = "scTabInactive";
//
...
<?php
  ...
  function cabecalho()
  {
     ...
     $nm_saida->saida("    <div class=\"scTabHeaderFont\" style=\"float: left; text-transform: uppercase;\">" . "ALTA CONSEJERÍA PARA LA SEGURIDAD CIUDADANA" . "</div>\r\n");
